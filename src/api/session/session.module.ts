...
@Module({
	...
	providers: [SessionService, FileUploadService, MailService, PdfService],
	imports: [TypeOrmModule.forFeature([Session, SessionPreparationFile,  Accompaniment, SessionAttachment])]
})
